            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SnackId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 100, nullable: true),
                    SummaryDescription = table.Column<string>(maxLength: 100, nullable: true),
                    FullDescription = table.Column<string>(maxLength: 255, nullable: true),
                    ...
                    IsFavoriteSnack = table.Column<bool>(nullable: false),
